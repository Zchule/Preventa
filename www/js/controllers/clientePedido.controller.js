CTRLS.controller('ClientePedidoCtrl', function($scope, $state, $ionicLoading, $ionicActionSheet, $ionicModal, Clientes, Pedidos, $ionicPopup, $cordovaGeolocation, $cordovaCamera) {
